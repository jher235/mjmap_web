      ...
      <hr className="featurette-divider"/>
        ...
        <div className="row post" onClick={()=>handlePostDetail(id)}>
          ...
          <div className="col-md-3 order-md-1">
            {image?<img src={image} className="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid ms-5"  width="150" height="150" alt=""/>
          ...
          <div className="col-md-4 order-md-2 post-sub">
            ...
            <div>
                        ...
                        {profile?
                        <>
                            <img src={profile.image} className="profile-image  img-fluid ms-3 me-3" width="40" height="40" alt="프로필이미지"/>
                            {profile.nickname}
                        </>
                        :<a>Loading...</a>
                        }
